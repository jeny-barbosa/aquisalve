...
$sQueryColaborador = "
        SELECT ID, NOME
          ...
          ORDER BY NOME
        ";
$sListColaborador  = mysqli_query($sConn, $sQueryColaborador);
...
$sListHoraTrabalhada = mysqli_query($sConn, $sSomaHoraTrabalhada);
...
$sHoraDiferenca  = "
                SELECT
                  ...
                  FROM MOVIDESK
                ";
$sTotalDiferenca = mysqli_query($sConn, $sHoraDiferenca);
...
$sQueryTang = "
            SELECT
              ...
              FROM TANGERINO
";
$sListTangerino = mysqli_query($sConn, $sQueryTang);
...
$sResultado = mysqli_query($sConn, $sQueryChamado);
